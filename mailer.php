...
$mail->Username = 'someone-another@domain.com';  // SMTP username
$mail->Password = 'password';   // SMTP password
$mail->SMTPSecure = 'tls';  // Enable encryption, 'ssl' also accepted
$mail->Port = 587;  //Set the SMTP port number - 587 for authenticated TLS
$mail->setFrom('someone-another@domain.com', 'name');  //Set who the message is to be sent from 
$mail->addAddress('someone-another@domain.com', 'name');  // Mail Receiver Address 
